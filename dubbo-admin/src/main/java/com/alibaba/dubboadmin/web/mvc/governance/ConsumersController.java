...
public class ConsumersController extends BaseController {
    ...
    public String index(HttpServletRequest request, HttpServletResponse response,
        ...
        if (consumers != null && consumers.size() > 0) {
            for (Consumer consumer : consumers) {
                ...
                List<Route> routed = new ArrayList<>();
    ...
    public String update(@ModelAttribute Consumer newConsumer,
                         HttpServletRequest request,
                         HttpServletResponse response,
                         Model model) {
    ...
    public String routed(@PathVariable("id") Long id,
                         HttpServletRequest request,
                         HttpServletResponse response,
                         Model model) {
    ...
    public String notified(@PathVariable("id") Long id,
                           HttpServletRequest request,
                           HttpServletResponse response,
                           Model model) {
    ...
    public String overrided(@PathVariable("id") Long id,
                            HttpServletRequest request,
                            HttpServletResponse response,
                            Model model) {
    ...
    public String shield(@PathVariable("ids") Long[] ids,
                         HttpServletRequest request,
                         HttpServletResponse response,
    ...
    public String tolerant(@PathVariable("ids") Long[] ids,
                           HttpServletRequest request,
                           HttpServletResponse response,
                           Model model) throws Exception {
    ...
    public String recover(@PathVariable("ids") Long[] ids,
                          HttpServletRequest request,
                          HttpServletResponse response,
                          Model model) throws Exception {
    ...
    public String allshield(@RequestParam(required = false) String service,
                            HttpServletRequest request,
                            HttpServletResponse response,
                            Model model) throws Exception {
    ...
    public String alltolerant(@RequestParam(required = false) String service,
                              HttpServletRequest request,
                              HttpServletResponse response,
                              Model model) throws Exception {
    ...
    public String allrecover(@RequestParam(required = false) String service,
                             HttpServletRequest request,
                             HttpServletResponse response,
                             Model model) throws Exception {
    ...
    private String allmock(String service,
                           String mock,
                           String methodName,
                           HttpServletRequest request,
                           HttpServletResponse response,
    ...
    @RequestMapping("/{ids}/allow") // 允许访问
    public String allow(@PathVariable("ids") Long[] ids,
                        HttpServletRequest request,
                        HttpServletResponse response,
                        Model model) throws Exception {
    ...
    @RequestMapping("/{ids}/forbid") // 禁止访问 通过路由实现
    public String forbid(@PathVariable("ids") Long[] ids,
                         HttpServletRequest request,
                         HttpServletResponse response,
                         Model model) throws Exception {
    ...
    public String onlyallow(@PathVariable("ids") Long[] ids,
                            HttpServletRequest request,
                            HttpServletResponse response,
                            Model model) throws Exception {
    ...
    public String onlyforbid(@PathVariable("ids") Long[] ids,
                             HttpServletRequest request,
                             HttpServletResponse response,
                             Model model) throws Exception {
    ...
    private String access(HttpServletRequest request, HttpServletResponse response, Long[] ids,
        ...
        Map<String, Set<String>> serviceAddresses = new HashMap<>();
        for (Consumer consumer : consumers) {
            String service = consumer.getService();
            String address = Tool.getIP(consumer.getAddress());
