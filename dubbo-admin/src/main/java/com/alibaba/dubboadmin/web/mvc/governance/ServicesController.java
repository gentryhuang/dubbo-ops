...
/**
 * 服务（provider/consumer纬度）的设置，对其下的具体服务进行降级和容错操作，是通过动态配置实现的。
 * URI: /services/$service/providers /addresses/$address/services /application/$application/services
 */
@Controller
...
public class ServicesController extends BaseController {
    ...
    public String index(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        Map<String, List<Override>> service2Overrides = new HashMap<>();
