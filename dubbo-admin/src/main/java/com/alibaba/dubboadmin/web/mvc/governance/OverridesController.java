...
public class OverridesController extends BaseController {
    ...
    public String edit(@PathVariable("id") Long id,
        ...
        List<String> methods = CollectionUtils.sort(new ArrayList<>(providerService.findMethodsByService(override.getService())));
        if (methods.isEmpty()) {
    ...
    public String create(Override override,
                         HttpServletRequest request,
                         HttpServletResponse response,
                         Model model) {
    ...
    public String update(Override override,
                         HttpServletRequest request,
                         HttpServletResponse response,
                         Model model) {
        prepare(request, response, model, "update", "overrides");
